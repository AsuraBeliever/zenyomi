package eu.kanade.tachiyomi.animeextension.installer
...
abstract class InstallerAnime(private val service: Service) {
    ...
    /**
     * InstallerAnime readiness. If false, queue check will not run.
     *
     * @see checkQueue
     */
     ...
     * of the completed entry ([waitingInstall]) to [AnimeExtensionManager].
     *

...
internal object AnimeExtensionLoader {
    ...
    fun installPrivateExtensionFile(context: Context, file: File): Boolean {
        ...
        if (currentExtension != null) {
            ...
            if (extensionSignatures.isNullOrEmpty()) {
                logcat(LogPriority.ERROR) { "AnimeExtension to be installed is not signed." }
                return false
            }
    ...
    suspend fun loadExtensionFromPkgName(context: Context, pkgName: String): AnimeLoadResult {
        ...
        if (extensionPackage == null) {
            logcat(LogPriority.ERROR) { "AnimeExtension package is not found ($pkgName)" }
     ...
     */
    private suspend fun loadExtension(context: Context, extensionInfo: ExtensionInfo): AnimeLoadResult {
        ...
        if (signatures.isNullOrEmpty()) {
            ...
            logcat(LogPriority.WARN) { "AnimeExtension $pkgName isn't trusted" }
        ...
        val classLoader = try {
            ...
            logcat(LogPriority.ERROR, e) { "AnimeExtension load error: $extName ($pkgName)" }
            return AnimeLoadResult.Error
        }
        ...
        val sources = appInfo.metaData.getString(METADATA_SOURCE_CLASS)!!
            ...
            .flatMap {
                try {
                    ...
                    logcat(LogPriority.ERROR, e) { "AnimeExtension load error: $extName ($it)" }
                    return AnimeLoadResult.Error
                }
            }

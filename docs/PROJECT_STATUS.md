...
| Velocidad de las fuentes sin lector propio | ⚠️ | Deuda conocida y aceptada en el ADR-0006: sin lector del manifiesto, los segmentos los pide ffmpeg de uno en uno. ~300–450 kB/s frente a ~2 MB/s del camino HLS. Se arregla añadiendo un lector de MPD al prefetcher, no tocando extensiones |
